function calcular() {
    ...
    var larguraVia = document.getElementById('campo2').value;
    ...
    var resultadoCalculadoPoste = calcularDistancias(distanciaEntrePostes);
    ...
    linha4.children[1].textContent = resultadoCalculadoPoste.distanciaCalculada1;
    linha4.children[2].textContent = resultadoCalculadoPoste.distanciaCalculada2;
    linha4.children[3].textContent = resultadoCalculadoPoste.distanciaCalculada3;
    linha4.children[4].textContent = resultadoCalculadoPoste.distanciaCalculada4;
    linha4.children[5].textContent = resultadoCalculadoPoste.distanciaCalculada5;

    // Limpar formulário após adicionar à tabela
    limparFormulario();
}
